...
Make sure your user install executable directory is on your PATH. Run this command to add it to the end of `~/.bashrc` and restart your shell by using `source ~/.bashrc` :
